...
// Include apps and components here..
...
@NgModule({
  ...
  // note to include your services here..else you get Uncaught (in promise): Error: StaticInjectorError
  providers: [SearchService, PythSrchService ],
